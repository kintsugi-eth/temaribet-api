...
const enrollement_1 = require("./enrollement");
const __1 = require("../..");
let LearningProgress = class LearningProgress {
};
__decorate([
    type_graphql_1.Field(returns => enrollement_1.Enrollement),
    __metadata("design:type", enrollement_1.Enrollement)
], LearningProgress.prototype, "enrollment", void 0);
__decorate([
    type_graphql_1.Field(returns => __1.CourseChapterContent),
    __metadata("design:type", __1.CourseChapterContent)
